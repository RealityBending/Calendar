...
**Day before the fullmoon between Moonfest and Risefest** `r format(celebrations["Harvestday"], "*(%Y %B %d - %A)*")`. Physical/sports games and competitions (hackathons) between colleagues.
