...
**Spring equinox** `r format(celebrations["Risefest"], "*(%Y %B %d - %A)*")`. Coming of **Bright days** and **Spring**. Drowning of the winter spirit ([Marzanna](https://wpna.fm/polish-traditions-the-drowning-of-marzanna/)). Eating eggs and water pranks. 
