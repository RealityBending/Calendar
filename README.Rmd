...
- **Fullmoon between Risefest and Lightfest** `r format(celebrations["Loversnight"], "*(%Y %B %d - %A night)*")`
...
- **Between Risefest and Lightfest** `r format(celebrations["Flowerday"], "*(%Y %B %d - %A)*")`
...
- **Summer solstice** `r format(celebrations["Lightfest"], "*(%Y %B %d - %A)*")`
...
- **Between Lightfest and Fallfest** `r format(celebrations["Harvestday"], "*(%Y %B %d - %A)*")`
